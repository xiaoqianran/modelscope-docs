<!-- modelscope-docs: 推理和部署 | llm-training-and-inference/user-guide/inference-and-deployment/inference-and-deployment_CN.md -->
...
### 使用Web-UI
如果你要使用界面的方式进行推理，可以查看[Web-UI文档](../入门介绍/Web-UI.md)。
