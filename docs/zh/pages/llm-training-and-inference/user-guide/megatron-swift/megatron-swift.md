<!-- modelscope-docs: Megatron-SWIFT训练 | llm-training-and-inference/user-guide/megatron-swift/megatron-swift_CN.md -->
...
- 自定义数据集格式和ms-swift相同，参考[自定义数据集文档](../定制化/自定义数据集.md)。
