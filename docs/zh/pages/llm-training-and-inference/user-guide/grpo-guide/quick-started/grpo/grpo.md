<!-- modelscope-docs: GRPO | llm-training-and-inference/user-guide/grpo-guide/quick-started/grpo/grpo_CN.md -->
...
GRPO参数参考[文档](../../../功能指引/命令行参数.md#grpo参数)
...
更多 rollout 参数参考[vLLM参数](../../../功能指引/命令行参数.md#vllm参数)和[rollout 参数](../../../功能指引/命令行参数.md#rollout参数)
...
> 训推一致性指标详细说明请参考文档 [Training-Inference-Mismatch](../先进算法/training_inference_mismatch.md)
