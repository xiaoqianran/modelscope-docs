<!-- modelscope-docs: training_inference_mismatch | llm-training-and-inference/user-guide/grpo-guide/advanced-research/training-inference-mismatch/training-inference-mismatch_CN.md -->
