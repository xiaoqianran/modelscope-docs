<!-- modelscope-docs: RLOO | llm-training-and-inference/user-guide/grpo-guide/advanced-research/rloo/rloo_CN.md -->
...
**GRPO**：将 KL 散度作为独立的正则化项添加到[损失函数](../入门介绍/GRPO.md#算法原理)中：
...
其他参数与 [GRPO参数](../../功能指引/命令行参数.md#grpo参数)一致
