<!-- modelscope-docs: entropy_mask | llm-training-and-inference/user-guide/grpo-guide/advanced-research/entropy-mask/entropy-mask_CN.md -->
...
同时使用参数`log_entropy`，可以记录训练过程中的熵值变化，参考[文档](../入门介绍/GRPO.md#logged-metrics)
