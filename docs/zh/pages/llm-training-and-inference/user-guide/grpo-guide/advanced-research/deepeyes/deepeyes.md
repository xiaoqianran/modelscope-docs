<!-- modelscope-docs: deepeyes | llm-training-and-inference/user-guide/grpo-guide/advanced-research/deepeyes/deepeyes_CN.md -->
...
在 plugin 文件中，使用OpenAI接口进行调用，参考[奖励模型文档](../更多支持/奖励模型.md#外部部署)
