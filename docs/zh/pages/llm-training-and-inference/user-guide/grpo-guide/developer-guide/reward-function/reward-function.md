<!-- modelscope-docs: 奖励函数 | llm-training-and-inference/user-guide/grpo-guide/developer-guide/reward-function/reward-function_CN.md -->
...
相关处理的列名参考[文档](../../../定制化/自定义数据集.md#query-response格式)
