<!-- modelscope-docs: 快速开始 | llm-training-and-inference/intro/quickstart/quickstart_CN.md -->

**注意**：最新文档建议查看[https://swift.readthedocs.io/zh-cn/latest/](https://swift.readthedocs.io/zh-cn/latest/)。
...
小贴士：
- 如果要使用自定义数据集进行训练，你可以参考[这里](../定制化/自定义数据集.md)组织数据集格式，并指定`--dataset <dataset_path>`。
