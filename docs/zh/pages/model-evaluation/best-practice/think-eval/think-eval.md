<!-- modelscope-docs: 模型思考效率评测最佳实践 | model-evaluation/best-practice/think-eval/think-eval_CN.md -->
...
![DeepSeek-R1-Distill-Qwen-7B思考效率](./_resources/DeepSeek-R1-Distill-Qwen-7B_math_500_metrics.png)
...
![6个模型思考效率对比](./_resources/model_comparison_metrics_6models.png)
*图2：6个模型思考效率对比率*
